...
const SETUP_TOOL = {
  ...
  description:
    ...
    "VibeFoundry runtime and vibe-coding toolchain. Detect the operating " +
...
const MAC_SETUP = [
  ...
  'echo "[4/5] Installing the Gemini, Claude, and Codex CLIs..."',
  'npm install -g @google/gemini-cli @anthropic-ai/claude-code @openai/codex',
  'echo "[5/5] Verifying VibeFoundry..."',
...
const WINDOWS_SETUP = [
  ...
  'Write-Host "[4/5] Installing the Gemini, Claude, and Codex CLIs..."',
  'npm install -g @google/gemini-cli @anthropic-ai/claude-code @openai/codex',
  'Write-Host "[5/5] Verifying VibeFoundry..."',
...
function buildSetupInstructions(os) {
  ...
  return [
    ...
    commands,
    "",
    "When all five steps succeed, scaffold the current task root and open VibeFoundry.",
  ].join("\n");
}
