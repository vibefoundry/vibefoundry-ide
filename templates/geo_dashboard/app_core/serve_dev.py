"""
Cross-platform dev HTTP server for the geo_dashboard plain-script PWA.

Picks a free port, opens the browser, and serves the src_app/ folder.
Replaces the previous Vite-based dev server. Run via run_app.sh /
run_app.bat (which call prepare_dev_assets.py first).
"""
import http.server
import os
import socket
