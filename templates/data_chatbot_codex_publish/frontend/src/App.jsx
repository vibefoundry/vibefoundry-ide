...
export default function App() {
  ...
  // Published-mode heartbeat: the silent backend self-shuts-down if no heartbeat
  // arrives for a grace window, so closing the last tab cleans up the process.
  // Harmless in dev — /api/heartbeat just 204s and no watchdog runs there.
  useEffect(() => {
